...
requireText(sidebar, 'aria-label="LUKE AI Studio home"', "SIDEBAR_BRAND_MISSING");
requireText(sidebar, 'role="tablist" aria-label="Choose Chat or Work mode"', "VISIBLE_MODE_TABS_MISSING");
requireText(sidebar, 'aria-selected={assistantMode === "chat"}', "CHAT_MODE_SELECTION_STATE_MISSING");
requireText(sidebar, 'aria-selected={assistantMode === "work"}', "WORK_MODE_SELECTION_STATE_MISSING");
...
requireText(workTools, 'fetch("/api/work/review/diff"', "WORK_REVIEW_DIFF_FETCH_MISSING");
requireText(workTools, "Staged + unstaged", "WORK_REVIEW_DIFF_SUMMARY_MISSING");
...
requireText(server, 'req.url === "/api/work/review/diff"', "WORK_REVIEW_DIFF_API_MISSING");
requireText(actionRunner, "runWorkFileDiff", "WORK_REVIEW_DIFF_RUNNER_MISSING");

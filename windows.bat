...
echo.
echo  ============================================================
echo   LUKE AI STUDIO      ^|  %SETUP_MODE%
echo  ============================================================
echo.
...
:: ── Launch ────────────────────────────────────────────────────────────────────
:launch
:: Offline-first automatic update check. Failure never blocks the installed version.
if exist "%NODE%" if exist "%~dp0scripts\updater\update.cjs" "%NODE%" "%~dp0scripts\updater\update.cjs" --launch-check
